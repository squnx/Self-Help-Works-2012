/* nanotabMessages ~ Sean Catchpole - Version 0.9 - MIT/GPL */
(function(){
  ...
  nanotabMessages = function(s){
    var i, s=s||{}, o="cesdf".split(''); 
    for(i in o) s[o[i]]=s[o[i]]||nanotabMessages.settings[o[i]];
  ...
  nanotabMessages.settings = { c:"nanotabMessages", e:"click", s:"selected", d:0, f:false };
  nanotabMessages();
