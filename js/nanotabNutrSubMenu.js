/* nanotab2 ~ Sean Catchpole - Version 0.9 - MIT/GPL */
(function(){
  ...
  tabNutrSubMenuSub = function(s){
    var i, s=s||{}, o="cesdf".split(''); 
    for(i in o) s[o[i]]=s[o[i]]||tabNutrSubMenuSub.settings[o[i]];
  ...
  tabNutrSubMenuSub.settings = { c:"tabNutrSubMenuSub", e:"click", s:"selected", d:0, f:false };
  tabNutrSubMenuSub();
